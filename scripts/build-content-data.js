...
async function buildContentData() {
  ...
  // 3. Build SQLite Database (src/data/content.db) - Optional Cross-Platform Compilation
  try {
    ...
    console.warn('⚠️ SQLite native compilation skipped (Production Store & MiniSearch Index compiled):', sqliteErr.message);
  }
