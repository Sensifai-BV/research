...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      ref={buttonRef}
      onClick={toggleTheme}
      className={cn("rounded-full text-zinc-500 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-zinc-100 transition-colors cursor-pointer flex items-center justify-center p-2", className)}
      {...props}
    >
